...
function TaskList({ search, priorityFilter, statusFilter }) {
  ...
  const getResources = (task) => {
    ...
    if (text.includes("html"))
      return {
        ...
        video:
          "https://www.youtube.com/results?search_query=html+tutorial",
    ...
    if (text.includes("css"))
      return {
        ...
        video:
          "https://www.youtube.com/results?search_query=css+tutorial",
    ...
    if (text.includes("mongodb"))
      return {
        ...
        practice: "https://www.mongodb.com/products/platform/atlas",
      };
    ...
    if (text.includes("ai") || text.includes("artificial"))
      return {
        ...
        video:
          "https://www.youtube.com/results?search_query=artificial+intelligence+tutorial",
  ...
  const filteredTasks = tasks.filter((task) => {
    ...
    const matchesSearch =
      ...
      task.course?.toLowerCase().includes(s);
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        {filteredTasks.map((task) => {
          ...
          return (
            <div
              key={task._id}
              className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-300 flex flex-col h-full"
            >
              <div>
              ...
              {res && (
                <div className="grid grid-cols-3 gap-2 mt-6">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-indigo-600 hover:bg-indigo-700 text-white text-center py-2 rounded-lg text-sm transition"
                  >
                    📖 Docs
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-red-600 hover:bg-red-700 text-white text-center py-2 rounded-lg text-sm transition"
                  >
                    🎥 Video
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-green-600 hover:bg-green-700 text-white text-center py-2 rounded-lg text-sm transition"
                  >
                    💻 Practice
                  </a>
                </div>
